...
def finalResult(a_file):
    ...
    figures = reader.read()
    maxVolume = 0 # відповідно ні проща, ні периметер не можуть бути менші за 0
    maxFigure = figures[0]
    ...
    print("And the champion is", maxFigure, "it's area =", maxVolume)
